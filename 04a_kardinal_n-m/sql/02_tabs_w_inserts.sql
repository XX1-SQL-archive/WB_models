...
-- Servants: Inserts
INSERT INTO `mydb`.`servants` (`id`, `srv_name`, `yrs_served`, `cats_id`) VALUES (DEFAULT, "Peter", 4, 2);
INSERT INTO `mydb`.`servants` (`id`, `srv_name`, `yrs_served`, `cats_id`) VALUES (DEFAULT, "Holger", 2, 1);
